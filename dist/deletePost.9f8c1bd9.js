...
getBlog();
},{"axios":"node_modules/axios/index.js","./makeHtml":"src/js/makeHtml.js"}],"src/js/deletePost.js":[function(require,module,exports) {
"use strict";
...
function _deletePost() {
  _deletePost = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var delet, _yield$axios$delete, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          delet = event.target.id;
          _context.prev = 2;
          _context.next = 5;
          return _axios.default.delete("http://localhost:3000/blogs/".concat(delet));
        case 5:
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/deletePost.js"], null)
//# sourceMappingURL=/deletePost.9f8c1bd9.js.map