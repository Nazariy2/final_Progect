...
function _updatePost() {
  _updatePost = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var _update, _yield$axios$patch, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _update = event.target.id;
          _context.prev = 2;
          _context.next = 5;
          return _axios.default.patch("http://localhost:3000/blogs/".concat(_update), {
