...
var _makeHtml = require("./makeHtml");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
...
getBlog();
},{"axios":"node_modules/axios/index.js","./makeHtml":"src/js/makeHtml.js"}],"src/js/updatePost.js":[function(require,module,exports) {
"use strict";
...
var updateInput = updateForm.elements.mainContent;
var updateId = null; // <- Per sapere quale post stiamo aggiornando
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          updatedText = updateInput.value.trim();
          if (updatedText) {
            _context.next = 6;
            break;
          }
        ...
        case 6:
          _context.prev = 6;
          _context.next = 9;
          return _axios.default.patch("http://localhost:3000/blogs/".concat(updateId), {
            article: {
              text: updatedText
            }
          });
        case 9:
          ...
          (0, _getBlogs.getBlog)(); // Ricarica la lista dei post
          _context.next = 18;
          break;
        case 15:
          _context.prev = 15;
          _context.t0 = _context["catch"](6);
          console.error("Errore durante l'aggiornamento:", _context.t0);
        case 18:
        case "end":
          return _context.stop();
      }
...
},{"axios":"node_modules/axios/index.js","./getBlogs":"src/js/getBlogs.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/updatePost.js"], null)
//# sourceMappingURL=/updatePost.ac59d020.js.map